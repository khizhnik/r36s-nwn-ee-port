...
json BuildSaveListState(object oPC, string sState, string sFolder, string sSaveName, string sArea, string sMTime)
{
    ...
    if (sState == "loaded")
    {
        int nSelectedIndex = GetLocalInt(oPC, "R36S_SELECTED_SAVE_INDEX");
        string sSelectedFolder = GetLocalString(oPC, "R36S_SELECTED_SAVE_FOLDER");
        string sEntryFolder = GetLocalString(oPC, "R36S_SAVEINDEX_0_FOLDER");
...
void main()
{
    ...
    if (GetLocalString(oPC, "R36S_SELECTED_SAVE_FOLDER") == "" || GetLocalInt(oPC, "R36S_SELECTED_SAVE_INDEX") < 0)
    {
