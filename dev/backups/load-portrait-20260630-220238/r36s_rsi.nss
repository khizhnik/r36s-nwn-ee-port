...
json BuildCharacterPanelState(object oPC, string sState, string sFolder, string sSaveName, string sArea, string sMTime)
{
    ...
    if (sState == "loaded")
    {
        ...
        jPanel = JsonArrayInsert(jPanel, NuiLabel(JsonString("Character: " + sCharacterName), JsonInt(NUI_HALIGN_LEFT), JsonInt(NUI_VALIGN_TOP)));
        jPanel = JsonArrayInsert(jPanel, NuiLabel(JsonString("Portrait: " + sPortraitResRef), JsonInt(NUI_HALIGN_LEFT), JsonInt(NUI_VALIGN_TOP)));
        jPanel = JsonArrayInsert(jPanel, NuiLabel(JsonString("Class: " + sClassName), JsonInt(NUI_HALIGN_LEFT), JsonInt(NUI_VALIGN_TOP)));
        jPanel = JsonArrayInsert(jPanel, NuiLabel(JsonString("Level: " + sLevel), JsonInt(NUI_HALIGN_LEFT), JsonInt(NUI_VALIGN_TOP)));
